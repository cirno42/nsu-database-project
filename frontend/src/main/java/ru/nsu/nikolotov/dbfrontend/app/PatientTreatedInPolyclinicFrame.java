...
public class PatientTreatedInPolyclinicFrame {
    private static final int FRAME_WIDTH = 600;
    private static final int FRAME_HEIGHT = 600;


    private final JFrame frame = new JFrame("Patients history");
    ...
    public PatientTreatedInPolyclinicFrame() {
...
//        updateEntityButton.addActionListener(l -> System.out.println(idTextField.getText()));
    ...
    private void getAllWards() {
        entities = PatientAPI.getPatientsWhoTreatedInPolyclinic();
    }
